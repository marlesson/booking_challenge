...
conf1_rnn = ProjectConfig(
    ...
    other_input_columns=[
        ...
        Column("item_action_count_list", IOType.INT_ARRAY),
        Column("item_tax_popularity_list", IOType.INT_ARRAY),
        Column("item_action_unique_user_list", IOType.INT_ARRAY),
        Column("item_action_count_in_trip_list", IOType.INT_ARRAY),
        Column("country_action_count_list", IOType.INT_ARRAY),
        Column("country_action_unique_user_list", IOType.INT_ARRAY),
